...
namespace STM32
{
    ...
    using I2C2 = I2C::Driver<I2C2_BASE, I2C2_EV_IRQn, I2C2_ER_IRQn, Clock::I2C2Clock, DMA::DMA1Stream7Channel7, DMA::DMA1Stream2Channel7>;

#ifdef I2C3_BASE
    // SCL: PA8; SDA: PC9; SMBA: PA9
    using I2C3 = I2C::Driver<I2C3_BASE, I2C3_EV_IRQn, I2C3_ER_IRQn, Clock::I2C3Clock, DMA::DMA1Stream4Channel3, DMA::DMA1Stream2Channel3>;
#endif
}
