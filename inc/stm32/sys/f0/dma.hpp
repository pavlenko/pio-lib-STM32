...
namespace STM32
{
    using _DMA1Channel1 = _DMA::Channel<_DMA::BusRegsF<DMA1_BASE>, _DMA::RegsF<DMA1_Channel1_BASE>, DMA1_Channel1_IRQn, 0>;
    using _DMA1Channel2 = _DMA::Channel<_DMA::BusRegsF<DMA1_BASE>, _DMA::RegsF<DMA1_Channel2_BASE>, DMA1_Channel2_3_IRQn, 1>;
